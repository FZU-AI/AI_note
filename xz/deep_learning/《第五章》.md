...
![test](charter5/image-20200628002402855.png)
...
- 参考ResNet论文的表1来实现不同版本的ResNet [1]。
  ...
  ![image-20200629180406719](charter5/image-20200629180406719.png)
...
- 实现DenseNet论文中的表1提出的不同版本的DenseNet [1]。
  ...
  答：![image-20200629175812837](charter5/image-20200629175812837.png)